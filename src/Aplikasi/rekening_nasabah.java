...
{
String[]judul={"No. Nasabah","Username","Tanggal","Keterangan","Saldo"};
...
bsimpan.setEnabled(true);
    ...
    if(evt.getKeyCode()==KeyEvent.VK_ENTER)
    {
        ...
        {
        con.setkoneksi();
        con.rs=con.st.executeQuery("select * from simpan where no_nas='"+tkode.getText()+"'");
            if(con.rs.next())
            {
                JOptionPane.showMessageDialog(null,"Nomer Nasabah Ditemukan");
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        ...
        {
            con.setkoneksi();
            String sql="delete from simpan where no_nas='"+tkode.getText()+"'";
            con.st.executeUpdate(sql);
            con.rs.close();
    ...
    private void bupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bupdateActionPerformed
        ...
        {
            con.setkoneksi();
            String sql="update simpan set username='"+tjenis.getText()+"',tanggal='"+tmaxpinj.getText()+"',ket='"+tmaxang.getText()+"',saldo='"+tbunga.getText()+"' where no_nas='"+tkode.getText()+"'";
            con.st.executeUpdate(sql);
            con.rs.close();
